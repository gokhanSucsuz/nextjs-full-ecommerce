...
// Variable: PRODUCTC_BY_CATEGORY_QUERY
// Query: *[        _type == "product"        && references(*[ _type =="category" && slug.current == $category]._id)    ] | order(name asc)
export type PRODUCTC_BY_CATEGORY_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Query: *[        _type == "sales"         && isActive == true         && couponCode == $couponCode         ] | order(validForm desc)[0]
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n    *[\n        _type == \"product\"\n        && references(*[ _type ==\"category\" && slug.current == $category]._id)\n    ] | order(name asc)\n        ": PRODUCTC_BY_CATEGORY_QUERYResult;
    "\n        *[ _type == \"product\" && name match $name ] | order(name asc)": SEARCH_PRODUCTS_BY_NAME_QUERYResult;
